...
DB="${DB:-ice_s05_replay_${RUN_ID}}"
CF="${CF:-s05-replay-${RUN_ID}}"
FAILPOINT="IcebergSinkExitAfterStageBeforePostFlush"
...
printf 'S05_REPLAY_PASS cf=%s summary=%s staged_after=%s staged_after_remove=%s\n' \

...
DB="${DB:-ice_s11_replay_${RUN_ID}}"
CF="${CF:-s11-replay-${RUN_ID}}"
FAILPOINT="IcebergSinkErrorAfterAppendBeforeStageDelete"
...
printf 'S11_REPLAY_PASS cf=%s summary=%s staged_after=%s staged_after_remove=%s\n' \
